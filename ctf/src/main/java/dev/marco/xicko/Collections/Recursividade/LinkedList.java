package dev.marco.xicko.Collections.Recursividade;
...
public class LinkedList<T>{
    ...
    //RECURSIVIDADE
    public void recurseLoop(Node<T> temp){
            if (temp==null){
                System.out.println();
            }else{
                System.out.println(temp.element);
                recurseLoop(temp.next);
            }
    }

    public String recurseLoopBack(Node<T> temp){
        String result="";
            if (temp==null){
                return "";
            }else{
                result= recurseLoopBack(temp.next)+"\n"+ temp.element;
                return result;
            }
    }
}
