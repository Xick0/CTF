package dev.marco.xicko.Collections.Grafos;

import dev.marco.xicko.Collections.Heaps.ArrayHeap;
import dev.marco.xicko.Collections.Heaps.LinkedHeap;
import dev.marco.xicko.Collections.Heaps.PriorityQueue;
import dev.marco.xicko.Collections.LinkedLists.LinkedList;
import dev.marco.xicko.Collections.ListasIterador.Classes.ArrayUnorderedList;
import dev.marco.xicko.Collections.ListasIterador.Classes.LinkedUnorderedList;
import dev.marco.xicko.Collections.Queue.LinkedQueue;
import dev.marco.xicko.Collections.Stacks.ArrayStack;
import dev.marco.xicko.Collections.Stacks.LinkedStack;
